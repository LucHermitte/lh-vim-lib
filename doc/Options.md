...
In order to simplify the process of fetching the value of such (plugin)
options, lh-vim-lib provides a few helper functions.
...
for instance C and C++. To simplify options tuning, `lh#ft#*()` functions
support filetype inheritance.
